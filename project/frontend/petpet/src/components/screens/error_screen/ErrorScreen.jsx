...
export default function ErrorScreen({error_code}){
    ...
    return <>
        ...
        <img style={{right: '0', top: '250px'}} className={classes.pig_paws} src={pig_paws} alt="Лапки свинки" />
        <img style={{right: '210px', top: '0px'}} className={classes.pig_paws} src={pig_paws_2} alt="Лапки свинки" />
        <img style={{left: '323px', bottom: '0'}} className={classes.tiger_paws} src={tiger_paws} alt="Лапки тигра" />
